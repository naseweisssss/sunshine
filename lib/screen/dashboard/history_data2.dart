...
class _HistoryData2State extends State<HistoryData2> {
  ...
  var items = [
    PlaceInfo('January', Color(0xff6DC8F3), Color(0xff73A1F9),
        4.4, '85.52', '25.99','19.47','0.07'),
    PlaceInfo('February', Color(0xffFFB157), Color(0xffFFA057), 3.7,
        '89.79', '25.92','18.86','0.07'),
    PlaceInfo('March', Color(0xffFF5B95), Color(0xffF8556D), 4.5,
        '84.06', '26.19','19.47','0.09'),
    PlaceInfo('April', Color(0xffD76EF5), Color(0xff8F7AFE), 4.1,
        '80.34', '26.52','20.14','0.12'),
    PlaceInfo('May', Color(0xff42E695), Color(0xff3BB2B8), 4.2,
        '87.77', '26.87','20.81','0.12'),
  ];
...
class PlaceInfo {
  ...
  PlaceInfo(this.name, this.startColor, this.endColor, this.rating,
      this.cloud, this.temp, this.humidity, this.wind);
}
